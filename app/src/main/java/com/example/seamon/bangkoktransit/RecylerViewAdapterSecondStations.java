...
public class RecylerViewAdapterSecondStations extends RecyclerView.Adapter<RecylerViewAdapterSecondStations.ViewHolder> {
    ...
    public RecylerViewAdapterSecondStations(Context context, ArrayList<String> mStationNames, String firstStation, String selectedAs) {
